    ...
    ui(new Ui::DashboardWidget)
{
    ...
    setCssProperty(ui->labelSquareXOS, "square-chart-wage");
    setCssProperty(ui->labelSquareMNRewards, "square-chart-mnrewards");
    setCssProperty(ui->labelXOS, "text-chart-wage");
    ...
    setCssProperty(ui->labelAmountXOS, "text-stake-wage-disable");
...
void DashboardWidget::onChartRefreshed() {
    ...
    if (chartData->totalStakes > 0 || chartData->totalMNRewards > 0) {
        setCssProperty(ui->labelAmountXOS, "text-stake-wage");
